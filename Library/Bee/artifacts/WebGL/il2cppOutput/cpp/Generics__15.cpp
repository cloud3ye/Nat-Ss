...
IL_007f:
	{
		...
		int32_t L_20 = V_4;
		RuntimeObject* L_21;
		L_21 = KeyValuePair_2_get_Key_mBFDCCC38D0FB9251EF6AFAF1CF1120BECFAD3A37_inline(((L_19)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_20))), il2cpp_rgctx_method(method->klass->rgctx_data, 21));
		if (L_21)
		{
			goto IL_009a;
		}
...
IL_009a:
	{
		...
		int32_t L_23 = V_4;
		RuntimeObject* L_24;
		L_24 = KeyValuePair_2_get_Key_mBFDCCC38D0FB9251EF6AFAF1CF1120BECFAD3A37_inline(((L_22)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_23))), il2cpp_rgctx_method(method->klass->rgctx_data, 21));
